...
@Autonomous(name = "Main Autonomous High Opposing", group = "Competition")
public class MainAutoHighOpposing extends LinearOpMode {//TODO: add reversing for competition
